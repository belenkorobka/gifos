...
import {navSearch} from './modules/nav-search.js'

let trendingWords = document.getElementById('trending-words')
let apiKey = 'hLVg1y4K20nd6clVt4UBInVDd0p8rsb1'
let offset = 0
...
let searchInputNav = document.getElementById('search-input-nav')
...
searchInput.addEventListener('keyup', () => {
    ...
    if(term) {
        ...
        inputActive(searchButtonHeader)
    } else {
        setTimeout(() => {
...
search(searchInputNav, formScroll)
